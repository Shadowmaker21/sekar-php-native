          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Jadwal Notulen</h3>
                <br>
                ...
                <br>
                <br>
                <h3 class="card-title">LINK ABSEN : http://localhost/multi/admin/index.php?page=page_absen </h3>
              </div>
              <div class="card-body">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" method="POST" action="index.php?page=edekom" enctype="multipart/form-data">
                <div class="card-body">
                ...
                <div class="form-group">
                  <label>Peserta</label>
                  <select class="select2" name="email[]" multiple="multiple" data-placeholder="Select a State" style="width: 100%;" value="<?php echo $row['email'] ?>">
                    <option value="kerry.thamrim@gmail.com">Direktur Utama</option>
                    <option value="hendrardi168@gmail.com">Direktur Kepatuhan</option>
                    <option value="kasmiati2.smg@gmail.com">Direktur Operasional</option>
                  ...
                  <div class="card-body">
                    <textarea class="form-control" name="ket" value="<?php echo $row['ket'] ?>">
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" method="POST" action="index.php?page=cnot" enctype="multipart/form-data">
                <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="jenis" value="Offline" readonly>
                  </div>
