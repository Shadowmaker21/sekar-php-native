...
include "../sekar/config/pages.php";
?>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="../sekar/cabs.php" enctype="multipart/form-data">
              <div class="form-group">
                   <label>Pilih Agenda Meeting Sesuai Jadwal</label> 
                   <select class="select2" name="agenda" data-placeholder="Pilih agenda Meeting" style="width: 100%;"required> 
                   <option value=""></option>
						        <option value="Meeting Bisnis">Meeting Bisnis</option>
                    <option value="Meeting Direksi">Meeting Direksi</option>
                    <option value="Meeting Penyelesaian Kredit Bermasalah Per Cabang">Meeting Penyelesaian Kredit Bermasalah Per Cabang</option>
                    <option value="Meeting Kerja">Meeting Kerja</option>
                    <option value="Meeting Kredit">Meeting Kredit</option>
                    <option value="Meeting Pra Raker">Meeting Pra Raker</option>    
                   </select> 
                   </div>
            ...
            <?php
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="tgl_join" class="form-control" id="exampleInputPassword1"  value="<?php date_default_timezone_set("Asia/Bangkok"); echo date("Y-m-d"); ?>" disabled>
                  </div>
                <!-- /.card-body -->
...
<script>
	...
	$("#pilihnik").change(function(){
        ...
        $("#pilihnik").html("<option> </option>");
			...
			{
				$.getJSON('../sekar/get_nik.php',{'nik_id' : getValue},function(data){
					var showData;
